...
<template>
  <transition appear>
    <div class="fixed inset-0 z-[9999] bg-white/80 backdrop-blur grid place-items-center" @click.self="emit('close')">
      <div :class="[!album && 'mb-72', 'w-[400px] transform rounded-2xl p-6 text-left align-middle']">
        ...
        <div class="mt-4">
          <button v-if="album" type="submit" class="flex items-center gap-0.5 ml-auto rounded bg-green-400 shadow px-2 h-[30px] text-lg font-medium text-white hover:bg-green-300 transition-colors" @click="submit">
