        ...
        <form class="flex min-h-full items-center justify-center p-4 text-center -translate-y-[4rem] md:translate-y-0" @submit.prevent="submit">
          <TransitionChild
            ...
            <DialogPanel class="w-full max-w-md transform rounded-2xl bg-amber-50 p-6 text-left align-middle shadow-xl transition-all">
              ...
              <div class="mt-4">
                <button type="submit" class="ml-auto block justify-center rounded-md border border-transparent bg-green-200 px-3 py-1 text-sm font-medium text-green-900 hover:bg-green-300 focus:outline-none" @click="submit">
                  Save
                </button>
              </div>
            </DialogPanel>
